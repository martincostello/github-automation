...
const dotnet_1 = __nccwpck_require__(9506);
...
async function run() {
    try {
        ...
        let github = (0, github_1.getOctokit)(githubToken);
        const owner = 'dotnet';
        const repo = 'core';
        ...
        if (releaseNotesUpdated) {
            for (const path of releaseNotesFiles) {
                const release = await (0, github_1.getFileContents)(github, owner, repo, path, currentSha);
        ...
        if (releaseNotesUpdated) {
            ...
            if (releaseNotes.some((release) => !(0, dotnet_1.isPreview)(release))) {
        ...
        if (updatedSha) {
            ...
            github = (0, github_1.getOctokit)(stateToken);
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(6180);
